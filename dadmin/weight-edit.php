                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label>
                                                <span class="label-text">WEIGHT NAME: *</span>
                                                <input type="text" name="cat_name" placeholder="Enter Weight Name.." class="form-control" value="<?php if(isset($_POST['cat_name'])){ echo $_POST['cat_name'];} else{ echo $varq['name'];}?>" required>
                                            </label>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <select name="classtype" id="classtype" class="form-control" required>
                                          ...
                                          <?php
                                          $sel_query=mysqli_query($conn,"SELECT * FROM `classtype` WHERE status='Active' AND id=2");
                                        ...
                                        <div class="form-group">
                                            <label>
                                                <span class="label-text">WEIGHT SYMBOL: *</span>
                                                <input type="text" name="cat_symbol" placeholder="Enter Weight Symbol.." class="form-control" value="<?php if(isset($_POST['cat_symbol'])){ echo $_POST['cat_symbol'];}else{ echo $varq['symbol'];}?>" required>
                                            </label>
                                        </div>
                                        <div class="form-group">
...
//                        print_r($_POST);                            print_r($_FILES); 
                        if(isset($_POST['submit']))
                        {
                         ...
                         $sel_query=mysqli_query($conn,"SELECT * FROM `size_class` WHERE classtype_id=$classtypeId AND trash='No' AND name='".$name."' AND id=!'".$sizeId."'");
                            ...
                            {
                                //echo "<script>";
                                echo '<div id="snackbar">This Weight Class is already added..</div>';
                           ...
                           $query = "UPDATE size_class
                               ...
                               $query=mysqli_query($conn,$query);
                                if($query)
                                {
                                    ...
                                    echo '<div id="snackbar">Weight Class Edited successfully..</div>';
                                    ...
                                    echo"var delay = 1000;setTimeout(function(){ window.location = 'view-classtype-list.php?id=2'; }, delay);";
                                    echo "</script>";
                                }
                                else
                                {
                                    echo '<div id="snackbar">Your Weight Class Not Edited..</div>';
                                    echo "<script> var x = document.getElementById('snackbar');x.className = 'show';setTimeout(function(){ x.className = x.className.replace('show', ''); }, 3000);</script>";
                                }
                        }
                    }
