                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label>
                                                ...
                                                <input type="text" name="cat_symbol" placeholder="Enter Size .." class="form-control" value="<?php if(isset($_POST['cat_symbol'])){ echo $_POST['cat_symbol'];}?>" required>
                                            </label>
                                        </div>
                                        <div class="form-group">
                            ...
                            else
                            {
                               $query=mysqli_query($conn,"INSERT INTO `size_class`(`classtype_id`,`name`,`symbol`) VALUES ('$classtypeId','$name','".$_POST['cat_symbol']."')");
                                if($query)
                                {
                                    ...
                                    echo '<div id="snackbar">Shoe Size Class add successfully..</div>';
                                ...
                                {
                                    echo '<div id="snackbar">Your Shoe Size Class Not Added..</div>';
                                    echo "<script> var x = document.getElementById('snackbar');x.className = 'show';setTimeout(function(){ x.className = x.className.replace('show', ''); }, 3000);</script>";
                                }
