                        ...
                        <table id="recordsListView">
                            ...
                            <?php 
                                ...
                                if(!empty($_GET['fromdate']) && !empty($_GET['todate'])){
                                    ...
                                    $todate=$_GET['todate'];
                                   $sel_query=mysqli_query($conn,"SELECT * FROM `order_status` WHERE tracking_status='Delivered' AND `date` BETWEEN '$fromdate' AND '$todate' ORDER BY id DESC");
                                        while($can_data1=mysqli_fetch_array($sel_query))
                                        {
                                        ...
                                        foreach($can_order_id1 as $can_order_id1)
                                        {
                                            ...
                                            $query1=mysqli_query($conn,"SELECT * FROM `order_status` WHERE order_id='$can_order_id1' AND tracking_status='Delivered'");
