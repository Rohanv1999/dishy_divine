  ...
  function fade_out() {
   ...
   $_POST['productSizes'][$key]=$abc;
            ...
            foreach ($_POST['productSizes'][$key] as $size) {
              ...
              $mySqlQuery = "INSERT INTO `products`(`cat_id`, `subcat_id`, `product_name`,`brand`,`class1`, `price`,`discount`, `length`,`height`,`width`, `weight`,`hot_deals`,`new_arrivals`,`top`,`cod`,`stock`,`in_stock`,`minimum`,`maximum`,`class0`,`product_code`,`group_code`,`date`,`time`, `tax`) VALUES "
                . "('$category','$subcategory','$product','" . addslashes($_POST['brand']) . "','" . $color . "','" . $price . "','" . $disc_price . "','$length','$height','$width','$weigth', '$hot','$new','$top','$cod','$stock','$inStockQ','$min','$max','" . $sizeInfo[0] . "','" . $p_uniqu . "','" . $groupCode . "','$date','$time', '$product_tax')";
...
// exit();
          ...
          $color = "";
          $mySqlQuery = "INSERT INTO `products`(`cat_id`, `subcat_id`, `product_name`,`brand`,`class1`, `price`,`discount`,`length`,`height`,`width`, `weight`,`hot_deals`,`new_arrivals`,`top`,`cod`,`stock`,`in_stock`,`minimum`,`maximum`,`class0`,`product_code`,`group_code`,`date`,`time`,`tax`) VALUES "
            . "('$category','$subcategory','$product','" . addslashes($_POST['brand']) . "','','" . $price . "','" . $disc_price . "','$length','$height','$width','$weigth','$hot','$new','$top','$cod','$stock','$inStockQ','$min','$max','','" . $p_uniqu . "','" . $groupCode . "','$date','$time', '$product_tax')";
          $query = mysqli_query($conn, $mySqlQuery) or die(mysqli_error());
   ...
   $_POST['productSizes'][$key]=$abc;
            ...
            foreach ($_POST['productSizes'][$key] as $v3 => $size) {
              ...
              foreach ($_POST['productSizesClass'][$key] as $k1 => $class) {
                ...
                $mySqlQuery = "INSERT INTO `products`(`cat_id`, `subcat_id`, `product_name`,`brand`,`class1`, `price`,`discount`,`length`,`height`,`width`, `weight`,`hot_deals`,`new_arrivals`,`top`,`cod`,`stock`,`in_stock`,`minimum`,`maximum`,`class0`,`class2`,`product_code`,`group_code`,`date`,`time`, `tax`) VALUES "
                  . "('$category','$subcategory','$product','" . addslashes($_POST['brand']) . "','" . $color . "','" . $price . "','" . $disc_price . "','$length','$height','$width','$weigth','$hot','$new','$top','$cod','$stock','$inStockQ','$min','$max','" . $sizeInfo[0] . "','" . $classInfo[0] . "','" . $p_uniqu . "','" . $groupCode . "','$date','$time', '$product_tax')";
                // echo $mySqlQuery;
                $query = mysqli_query($conn, $mySqlQuery) or die(mysqli_error());
