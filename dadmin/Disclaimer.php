...
<?php
    ...
    {
     $title=$_POST['title'];
     $ins=mysqli_query($conn,"INSERT INTO `disclaimer_title`(`title`) VALUES ('$title')");
    ...
    foreach($description as $key => $value)
        {
            $query=mysqli_query($conn,"INSERT INTO `disclaimer_desc`(`title_id`, `description`) VALUES ('$last','$value')");
             }
             if($query){
