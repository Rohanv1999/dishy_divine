                    ...
                    <div class="panel-content">
                                <form action="" method="post" enctype="multipart/form-data" name="form">                                
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="title" class="form-control" required placeholder="Enter Question   ..">
                                        </div>
                                    </div>
                                <div class="input_wrap">
                                    <div class="form-group row">
                                        <span class="label-text col-md-3 col-form-label">Answer/Description: </span>
                                        <div class="col-md-9">
...
<?php
    ...
    {
     $title=$_POST['title'];
     $ins=mysqli_query($conn,"INSERT INTO `faq_title`(`title`) VALUES ('$title')");
    ...
    foreach($description as $key => $value)
        {
            $query=mysqli_query($conn,"INSERT INTO `faq`(`title_id`, `description`) VALUES ('$last','$value')");
             }
             if($query){
                ...
                echo"var delay = 1000;setTimeout(function(){ window.location = 'faq-view.php'; }, delay);";
                echo "</script>";
             }
     } 
