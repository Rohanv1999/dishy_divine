...
<?php
    ...
    if(isset($_POST['submit']))
    {
     ...
     $ins=mysqli_query($conn,"INSERT INTO `return_exchange_title`(`title`, `date`, `time`) VALUES ('$title', '$date', '$time')");
    ...
    foreach($description as $key => $value)
        ...
        {    $value = mysqli_real_escape_string($conn, $value);
            $query=mysqli_query($conn,"INSERT INTO `return_exchange_desc`(`title_id`, `description`) VALUES ('$last','$value')");
             }
             if($query){
